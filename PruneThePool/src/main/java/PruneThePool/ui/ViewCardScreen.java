...
public class ViewCardScreen extends DiscardPileViewScreen {
    private static final UIStrings uiStrings = CardCrawlGame.languagePack.getUIString(PruneThePool.makeID("PruneCounter"));
    ...
    private static final String HEADER_INFO = uiStrings.TEXT_DICT.get("PruneScreen");
    ...
    public void reopen() {
        ...
        AbstractDungeon.overlayMenu.cancelButton.show(uiStrings.TEXT_DICT.get("cancel"));
    }
    ...
    public static class LoadBackupScreen {
        ...
        public static void patch() {
            if(PruneCounter.backup != null) {
                AbstractDungeon.discardPileViewScreen = PruneCounter.backup;
                PruneCounter.backup = null;
            }
        }
    }

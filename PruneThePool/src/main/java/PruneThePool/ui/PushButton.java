...
public class PushButton extends LabledButton{
    protected static UIStrings uiStrings = CardCrawlGame.languagePack.getUIString(PruneThePool.makeID("PushButton"));
    public int slot;

    public PushButton(int slot) {
